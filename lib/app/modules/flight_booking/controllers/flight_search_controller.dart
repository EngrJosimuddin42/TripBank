...
class FlightSearchController extends GetxController {
  ...
  static const double defaultMaxTravelTime = 30;
  ...
  // Flight Classes Data
  static List<Map<String, dynamic>> get flightClassesData => [
  ...
  // Facilities Data
  static List<Map<String, dynamic>> get facilitiesData => [
  ...
  // Filter Options
  final priceRange = RangeValues(minPrice, maxPrice).obs;
  final selectedAirlines = <String>[].obs;
  final selectedStops = <String>[].obs;
  final sortBy = 'Cheapest'.obs;
  final maxTravelTime = defaultMaxTravelTime.obs;
  ...
  Future<void> loadAirlines() async {
    try {
      availableAirlines.value = defaultAirlines;
    } catch (e) {
      availableAirlines.value = defaultAirlines;
    }
  }
  ...
  Future<void> loadFlightClasses() async {
    try {
      availableClasses.value = flightClassesData
  ...
  List<Flight> _generateDemoFlights() {
    final bookingController = Get.find<FlightBookingController>();
    final currentClass = bookingController.selectedClass.value;
  ...
  void resetFilters() {
    ...
    maxTravelTime.value = defaultMaxTravelTime;
